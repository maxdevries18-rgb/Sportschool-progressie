...
export default async function ExercisesPage({
  ...
  const { exercises, total, totalPages } = await getAllExercises(selectedGroup, search, page);
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {exercises.map((exercise) => (
              <Link
                ...
                className="group rounded-xl bg-white dark:bg-gray-900 shadow-[var(--shadow-card)] ring-1 ring-gray-200/60 dark:ring-gray-700/60 transition hover:shadow-[var(--shadow-card-hover)] overflow-hidden"
              >
                <ExerciseImage
