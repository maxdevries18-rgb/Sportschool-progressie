          ...
          <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="rounded-lg bg-indigo-600 px-6 py-3 sm:py-2 text-sm font-medium text-white shadow-sm transition hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Volgende
              </button>
            </div>
        ...
        {step === 2 && (
          <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
            ...
            <div className="mt-6 flex justify-between">
              <button
                onClick={() => setStep(1)}
                className="rounded-lg bg-white px-6 py-3 sm:py-2 text-sm font-medium text-gray-700 shadow-sm ring-1 ring-gray-300 transition hover:bg-gray-50"
              >
                Vorige
              </button>
              <button
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="rounded-lg bg-indigo-600 px-8 py-3 sm:py-2 text-sm font-medium text-white shadow-sm transition hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
